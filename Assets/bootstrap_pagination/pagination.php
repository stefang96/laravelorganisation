...
class bootPagination
{
		...
		if($this->totalrecords > $this->pagesize)
	    {
			...
			if ($this->pagenumber > 1)
			{
			   if ($this->showfirst && $this->paginationstyle != 2)
			   {
				   ...
				   if($this->defaultUrl == "")
				      $this->defaultUrl = "#";
				   //$paginationlst .= "<li class=\"page-item\"><a id=\"p_1\" href=\"" . $this->defaultUrl . "\" class=\"page-link\" data-toggle=\"tooltip\" title=\"" . $tooltip . "\"><i class=\"glyphicon glyphicon-backward\"></i></a></li>\n";
				   $paginationlst .= "<li class=\"page-item\"><a id=\"p_1\" href=\"" . $this->defaultUrl . "\" class=\"page-link\" data-toggle=\"tooltip\" title=\"" . $tooltip . "\">&lt;&lt;</a></li>\n";
				}
				...
				$paginationlst .= "<li" . $prevPageCss . "><a id=\"pp_" . $pid . "\" href=\"" . $this->prepareUrl($pid) . "\" data-toggle=\"tooltip\" class=\"page-link\" title=\"" . $tooltip . "\">" . $prevIcon . "</a></li>\n";
				// Normal Links
				if($this->paginationstyle != 2)
		...
		if(count($arr) > 0)
	    {
		   foreach ($arr as $item){
			   ...
			   $lastbound = $firstbound + $pagesize - 1;
                ...
                $script .= "<li" . $css . "><a id=\"pg_" . $item . "\" href=\"" . $this->prepareUrl($item) . "\" class=\"page-link\" data-toggle=\"tooltip\" title=\"" . $tooltip . "\">" . $item . "</a></li>\n";
	       }
	   }
       return $script;
    }
    ...
    function generate_previous_last_links($totalpages, $totalrecords, $pagenumber, $pagesize, $showlast)
    {
        ...
        $script .= "<li" . $nextPageCss . "><a id=\"pn_" . $pid . "\" href=\"" . $this->prepareUrl($pid) . "\" class=\"page-link\" data-toggle=\"tooltip\" title=\"" . $tooltip . "\">" . $nextPageIcon . "</a></li>\n";
        if ($showlast && $this->paginationstyle != 2)
        {
            ...
            $tooltip = "showing " . $firstbound . " - " . $lastbound . " records of " . $totalrecords . " records";
            //$script .= "<li class=\"page-item\"><a id=\"pl_" . $totalpages . "\" href=\"" . $this->prepareUrl($totalpages) . "\" class=\"page-link\" data-toggle=\"tooltip\" title=\"" . $tooltip . "\"><i class=\"glyphicon glyphicon-forward\"></i></a></li>\n";
            $script .= "<li class=\"page-item\"><a id=\"pl_" . $totalpages . "\" href=\"" . $this->prepareUrl($totalpages) . "\" class=\"page-link\" data-toggle=\"tooltip\" title=\"" . $tooltip . "\">&gt;&gt;</a></li>\n";
        }
        return $script;
